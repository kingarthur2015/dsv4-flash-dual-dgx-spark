...
echo "  cd <repo>"
echo "  ssh spark02 'cd <repo> && docker compose --profile worker down && docker compose --profile worker up -d'"
echo "  ssh spark01 'cd <repo> && docker compose --profile head down && docker compose --profile head up -d'"
